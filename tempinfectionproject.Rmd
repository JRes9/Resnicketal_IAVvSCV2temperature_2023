...
pheatmap(full, cluster_rows=TRUE, show_rownames= FALSE, cluster_cols=TRUE, annotation_col=forgraph,annotation_colors = ann_colors)
...
forgraph$condition <- c("F2433","F2433","F2433", "F2437","F2437","F2437", "F4833","F4833","F4833", "F4837","F4837","F4837", "M2433","M2433","M2433", "M2437","M2437","M2437", "M4833", "M4833","M4833", "M4837", "M4837","M4837","S2433", "S2433","S2433","S2437","S2437","S2437", "S4833","S4833","S4833", "S4837","S4837","S4837")
...
pdf(file="mock33beer.pdf", width = 8, height = 4)
mock33beerplot
dev.off()
...
pdf(file="mock37beer.pdf", width = 8, height = 4)
mock37beerplot
dev.off()
...
pdf(file="pc1right.pdf", width = 8, height = 4)
pc1rightplot
dev.off()
...
pc1leftplot <- ggplot(pc1left, aes(x= pc1left$Pathway.Name, y = pc1left$Fraction.Overalp, fill = p.value))+
  geom_col(position="dodge", width = 0.4, size=0.7, col="black")+
  coord_flip() + viridis::scale_fill_viridis(option = "mako")+
  ggplot2::xlab("")+
  ggplot2::ylab("Fraction Overlap")+
...
pdf(file="pc1left.pdf", width = 8, height = 4)
pc1leftplot
dev.off()
...
pdf(file="pc4right.pdf", width = 8, height = 4)
pc4rightplot
dev.off()
...
pdf(file="pc4left.pdf", width = 8, height = 4)
pc4leftplot
dev.off()
...
pdf(file="all33.pdf", width = 8, height = 4)
all33plot
dev.off()
...
pdf(file="all37.pdf", width = 8, height = 4)
all37plot
dev.off()
...
defgenes <- pheatmap(m, color= colorRampPalette(c("purple4", "white", "hotpink1"))(100), scale = "row", cellheight = 12, annotation_col=forgraph, annotation_colors= ann_colors,cluster_columns= TRUE,cluster_rows= TRUE, angle_col = 45)
...
defgenes <- pheatmap(m4, color= colorRampPalette(c("purple4", "white", "hotpink1"))(100), scale = "row", cellheight = 12, annotation_col=forgraph, annotation_colors= ann_colors,cluster_columns= TRUE,cluster_rows= TRUE, angle_col = 45)
...
barplot(gp_mod_enrichmock, order=TRUE, showCategory = 20, font.size = 5, color = "p.adjust") +
...
upflu = subset(sigresultsflu33v3748, log2FoldChange > 1.5)
downflu = subset(sigresultsflu33v3748, log2FoldChange < -1.5)
...
barplot(gp_mod_enrichflu, order=TRUE, showCategory = 20, font.size = 5, color = "p.adjust") +
  viridis::scale_fill_viridis(option = "mako")+
  ggplot2::facet_grid(~Cluster) 
...
upflu = subset(sigresultsflu33v3724, log2FoldChange > 1.5)
downflu = subset(sigresultsflu33v3724, log2FoldChange < -1.5)
...
#plot
#enrichplot::dotplot(gp_mod_clusterflu, font.size = 7, showCategory = 50)
barplot(gp_mod_enrichflu, order=TRUE, showCategory = 30, font.size = 5, color = "p.adjust") +
  viridis::scale_fill_viridis(option = "mako")+
  ggplot2::facet_grid(~Cluster) 
...
barplot(gp_mod_enrichvirusup, order=TRUE, showCategory = 20, font.size = 5, color = "p.adjust") +
  viridis::scale_fill_viridis(option = "mako")+
  ggplot2::facet_grid(~Cluster) 
...
barplot(gp_mod_enrichvirusdown, order=TRUE, showCategory = 20, font.size = 5, color = "p.adjust") +
  viridis::scale_fill_viridis(option = "mako")+
  ggplot2::facet_grid(~Cluster) 
